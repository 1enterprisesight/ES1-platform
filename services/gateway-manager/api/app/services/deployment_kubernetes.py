        ...
        configmap = client.V1ConfigMap(
            metadata=client.V1ObjectMeta(
                ...
                labels={
                    ...
                    "managed-by": "gateway-manager",
                },
                annotations={
                    "gateway-manager.es1.io/created-at": datetime.utcnow().isoformat(),
                },
            ),
    ...
    async def _cleanup_old_configmaps(self) -> None:
        ...
        try:
            ...
            configmaps = await asyncio.to_thread(
                ...
                namespace=self.namespace,
                label_selector="managed-by=gateway-manager,app=krakend",
            )
        ...
        try:
            ...
            for cm in configmaps.items:
                ...
                created_at = cm.metadata.annotations.get(
                    "gateway-manager.es1.io/created-at",
